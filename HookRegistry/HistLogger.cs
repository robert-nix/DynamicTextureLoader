...
namespace HookRegistry
{
    ...
    public static class TagFormat
    {
        ...
        static readonly Dictionary<GAME_TAG, Type> TypedTags = new Dictionary<GAME_TAG, Type>
        {
    ...
    [RuntimeHook]
    public class HistLogger
    {
        public TextWriter log;
        static JsonSerializer test;

        public object OnCall(string typeName, string methodName, params object[] args)
        {
            if (log == null)
            {
            ...
            if (typeName.EndsWith("GameState") && methodName == "OnPowerHistory")
            {
